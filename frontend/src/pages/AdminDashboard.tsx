// Admin Dashboard - EcoFlow Design System
            ...
            <div className="flex">
                ...
                <main className="flex-1 p-8">
                    <div className="max-w-7xl mx-auto">
                        <h2 className="text-page-title text-text-primary mb-6">Admin Dashboard</h2>

                        <div className="bg-surface border border-border rounded card-spacing">
                            <p className="text-sm text-text-secondary">
                                Welcome to the Admin Dashboard. This is a placeholder page.
                            </p>
